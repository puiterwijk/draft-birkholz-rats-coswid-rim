...
| firmware-manufacturer-id | 1 | An IANA defined unique value that is a Private Enterprise Number (Platform manufacturer unique identifier)that MUST be included in a CoSWID RIM.
